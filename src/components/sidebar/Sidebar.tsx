...
export default function Sidebar({ variant = "admin" }: { variant?: SidebarVariant }) {
    ...
    return (
        <aside
            className={`${open ? "w-[15%]" : "w-[5%]"} h-screen bg-white dark:bg-neutral-900 border-r border-gray-200 dark:border-neutral-800 transition-all duration-200 flex flex-col justify-between`}
        >
                ...
                <div className="flex items-center gap-3 px-4 py-5">
                    <div className="flex items-center gap-3 w-full">
                        <div className="shrink-0 h-10 w-10 rounded-full bg-gray-200 dark:bg-neutral-800 flex items-center justify-center">
                            {/* simple logo mark */}
                            <svg viewBox="0 0 24 24" className="h-6 w-6 text-gray-700 dark:text-gray-200" fill="none" xmlns="http://www.w3.org/2000/svg">
